...
import siswa.nilai_siswa;
import tata_usaha.manajemen_nilai.nilai;
import walkes.nilai_walkes;

public class login_walkes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 190, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/guru.png"))); // NOI18N
        ...
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 310, -1, -1));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("NIP");
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 250, -1, -1));

        txt_kelas.setFont(new java.awt.Font("Tekton Pro", 1, 36)); // NOI18N
        jPanel4.add(txt_kelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 80, 40));

        txt_username.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPanel4.add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 250, 240, 40));

        txt_pass.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPanel4.add(txt_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 310, 240, 40));
        ...
        jPanel4.add(btn_cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 370, 110, 30));
        ...
        jPanel4.add(btn_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 370, -1, 30));
    ...
    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        new login_walkes().setVisible(false);
        dispose();
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        try{
            ...
            String nip = txt_username.getText();
            String kelas = txt_kelas.getSelectedItem().toString();
            
            stm = con.createStatement();
            RsUser = stm.executeQuery("select * from walkes where nip_walkes='"+nip+"'"+" and kelas_walkes='"+kelas+"' and pass_walkes='"+password+"' ");
            int baris = 0;
            while (RsUser.next()){
                baris = RsUser.getRow();
            }
            if (baris == 1){
                ...
                new login_walkes().setVisible(false);
                dispose();
                new nilai_walkes().setVisible(true);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_walkes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
