...
public class login_admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(txt_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 240, 40));
        ...
        jPanel4.add(btn_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 320, 120, 30));
    ...
    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
        new login_admin().setVisible(false);
        dispose();
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        if(txt_user.getText().equals("admin") && txt_pass.getText().equals("admin")){
            //kalau username dan password benar
            JOptionPane.showMessageDialog(rootPane, "login berhasil");
            new login_admin().setVisible(false);
            dispose();
            new home().show();
        }else{
            JOptionPane.showMessageDialog(rootPane, "login tidak berhasil");
            txt_user.setText("");
            txt_pass.setText("");
