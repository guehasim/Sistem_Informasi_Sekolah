...
public class login_kepsek extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icon_kepsek.png"))); // NOI18N
        ...
        jPanel4.add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 240, 40));
    ...
    private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelActionPerformed
       new login_kepsek().setVisible(false);
       dispose();
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        try{
            ...
            String nis = txt_username.getText();
            
            stm = con.createStatement();
            RsUser = stm.executeQuery("select * from kepsek where nip_kepsek='"+nis+"'"+" and pass_kepsek='"+password+"' ");
            int baris = 0;
            while (RsUser.next()){
                baris = RsUser.getRow();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_kepsek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
